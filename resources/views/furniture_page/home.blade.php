...
@section('content')
    ...
    <div class="why-choose-section">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    ...
                    <div class="row my-5">
                        <div class="col-6 col-md-6">
                            <div class="feature">
                                <div class="icon">
                                    <img src="{{ asset('asset/client/images/truck.svg') }}" alt="Image"
                                        class="imf-fluid">
                                </div>
                        ...
                        <div class="col-6 col-md-6">
                            <div class="feature">
                                <div class="icon">
                                    <img src="{{ asset('asset/client/images/support.svg') }}" alt="Image"
                                        class="imf-fluid">
                                </div>
                                <h3>24/7 Support</h3>
                                <p>Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate.
                        ...
                        <div class="col-6 col-md-6">
                            <div class="feature">
                                <div class="icon">
                                    <img src="{{ asset('asset/client/images/return.svg') }}" alt="Image"
                                        class="imf-fluid">
                                </div>
                ...
                <div class="col-lg-5">
                    <div class="img-wrap">
                        <img src="{{ asset('asset/client/images/why-choose-us-img.jpg') }}" alt="Image"
                            class="img-fluid">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <div class="imgs-grid">
                        <div class="grid grid-1"><img src="{{ asset('asset/client/images/img-grid-1.jpg') }}"
                                alt="Untree.co"></div>
                        <div class="grid grid-2"><img src="{{ asset('asset/client/images/img-grid-2.jpg') }}"
                                alt="Untree.co"></div>
                        <div class="grid grid-3"><img src="{{ asset('asset/client/images/img-grid-3.jpg') }}"
                                alt="Untree.co"></div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="product-item-sm d-flex">
                        <div class="thumbnail">
                            <img src="{{ asset('asset/client/images/relaxingsofa/Relaxing-Sofa-1.png') }}" alt="Image"
                                class="img-fluid">
                        </div>
                        <div class="pt-3">
                            <h3>Nordic Chair</h3>
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="product-item-sm d-flex">
                        <div class="thumbnail">
                            <img src="{{ asset('asset/client/images/relaxingsofa/Relaxing-Sofa-2.png') }}" alt="Image"
                                class="img-fluid">
                        </div>
                        <div class="pt-3">
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="product-item-sm d-flex">
                        <div class="thumbnail">
                            <img src="{{ asset('asset/client/images/relaxingsofa/Relaxing-Sofa-3.png') }}" alt="Image"
                                class="img-fluid">
                        </div>
                        <div class="pt-3">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                    <div class="post-entry">
                        <a href="#" class="post-thumbnail"><img
                                src="{{ asset('asset/client/images/post-1.jpg') }}" alt="Image"
                                class="img-fluid"></a>
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                    <div class="post-entry">
                        <a href="#" class="post-thumbnail"><img
                                src="{{ asset('asset/client/images/post-2.jpg') }}" alt="Image"
                                class="img-fluid"></a>
                        <div class="post-content-entry">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                    <div class="post-entry">
                        <a href="#" class="post-thumbnail"><img
                                src="{{ asset('asset/client/images/post-3.jpg') }}" alt="Image"
                                class="img-fluid"></a>
                        <div class="post-content-entry">
    ...
    @if (session('success'))
        <script>
            swal("Logged in successfully!", "You clicked the button!", "success");
        </script>
    @endif
    @if (session('error'))
        <script>
            swal("Logged in successfully!", "You clicked the button!", "error");
        </script>
    @endif
    <!-- End Blog Section -->
@endsection
...
{{-- <script>
    function fetchProducts() {
        axios.get('http://127.0.0.1:8000/api/client/home')
            .then(response => {
                const productList = document.getElementById('productList');
                productList.innerHTML = ''; // Clear previous list
                response.data.randomProducts.forEach(product => {
                    const listItem = document.createElement('div');
                    listItem.classList.add('col-12', 'col-md-4', 'col-lg-3', 'mb-5', 'mb-md-0');
                    listItem.innerHTML = `
                ...
                `;
                    productList.appendChild(listItem); // Append listItem to productList
                });
            })
